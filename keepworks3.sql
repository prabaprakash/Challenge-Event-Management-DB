...
CREATE TABLE user_event_attendance (
    ...
    updated_at timestamp with time zone,
    event_bid_id integer,
    CONSTRAINT user_event_attendance_pay_check CHECK (((((attendance)::text = 'attending'::text) AND (event_bid_id IS NOT NULL)) OR ((attendance)::text <> 'attending'::text)))
);
...
--
-- Name: user_event_bids; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE user_event_bids (
    id integer NOT NULL,
    event_id integer NOT NULL,
    bid double precision NOT NULL,
    created_at timestamp with time zone DEFAULT '2017-01-06 11:17:06.492581+00'::timestamp with time zone NOT NULL,
    updated_at timestamp with time zone
);


ALTER TABLE user_event_bids OWNER TO postgres;

--
-- Name: user_event_bids_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE user_event_bids_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE user_event_bids_id_seq OWNER TO postgres;

--
-- Name: user_event_bids_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE user_event_bids_id_seq OWNED BY user_event_bids.id;
...
--
-- Name: user_event_bids id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY user_event_bids ALTER COLUMN id SET DEFAULT nextval('user_event_bids_id_seq'::regclass);
...
9	1	\N	sounds good	2017-01-05 08:52:26.642724+00	\N	2
\.
...
SELECT pg_catalog.setval('user_comments_id_seq', 9, true);
...
COPY user_event_attendance (id, user_id, event_id, attendance, created_at, updated_at, event_bid_id) FROM stdin;
9	4	1	attending	2017-01-05 14:35:24.142473+00	\N	2
1	1	1	attending	2017-01-05 14:35:24.142473+00	2017-01-06 13:17:19.73867+00	1
2	2	1	may_be	2017-01-05 14:35:24.142473+00	\N	\N
14	2	2	attending	2017-01-05 14:35:24.142473+00	\N	3
\.
...
SELECT pg_catalog.setval('user_event_attendance_id_seq', 16, true);


--
-- Data for Name: user_event_bids; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY user_event_bids (id, event_id, bid, created_at, updated_at) FROM stdin;
1	1	100	2017-01-06 11:17:06.492581+00	\N
2	1	250	2017-01-06 11:26:00.832663+00	\N
3	2	250	2017-01-06 13:25:51.214672+00	\N
\.


--
-- Name: user_event_bids_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('user_event_bids_id_seq', 3, true);
...
2	4	Wowapp Hackathon	Microsoft Campus Connect, Hackathon	2017-01-05 15:24:50.342304+00	2017-01-05 14:31:02.406904+00	\N
\.
...
SELECT pg_catalog.setval('user_events_id_seq', 2, true);
...
--
-- Name: user_event_attendance user_event_attendance_user_id_event_id_event_bid_id; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY user_event_attendance
    ADD CONSTRAINT user_event_attendance_user_id_event_id_event_bid_id UNIQUE (user_id, event_id, event_bid_id);


--
-- Name: user_event_bids user_event_bids_id; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY user_event_bids
    ADD CONSTRAINT user_event_bids_id UNIQUE (id);
...
--
-- Name: user_event_attendance user_event_attendance_event_bid_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY user_event_attendance
    ADD CONSTRAINT user_event_attendance_event_bid_id_fkey FOREIGN KEY (event_bid_id) REFERENCES user_event_bids(id);
...
--
-- Name: user_event_bids user_event_bids_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY user_event_bids
    ADD CONSTRAINT user_event_bids_event_id_fkey FOREIGN KEY (event_id) REFERENCES user_events(id);
